...
float const a_v_out[] = {1.5f, 1.5f, 1.5f};
float const a_th_out[] = {1.5f, 1.5f, 1.5f};
float const a_t_out[] = {1.5f, 1.5f, 1.5f};
float const d_v_out[] = {0.7f, 0.7f, 0.7f};
float const d_th_out[] = {0.7f, 0.7f, 0.7f};
...
NeuronConf const conf_out = {0,       3,        a_v_out, a_th_out, a_t_out,
